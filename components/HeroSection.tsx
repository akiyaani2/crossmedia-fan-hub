    ...
    <section className="relative text-center py-24 px-4 min-h-[80vh] md:min-h-[75vh] flex flex-col justify-center items-center 
      ...
      <div className="absolute bottom-0 left-0 right-0 p-4 z-10">
        <div className="max-w-4xl mx-auto overflow-x-auto whitespace-nowrap no-scrollbar text-center">
          {[ { text: 'Trending Now', icon: <Sparkles className="w-3 h-3 mr-1.5" />, href: '/explore?sort=trending' },
             { text: 'Latest Fanfics', icon: <BookOpen className="w-3 h-3 mr-1.5" />, href: '/explore?type=fanfic' },
             { text: 'New Videos', icon: <Film className="w-3 h-3 mr-1.5" />, href: '/explore?type=video' },
             { text: 'Fresh Podfics', icon: <Mic className="w-3 h-3 mr-1.5" />, href: '/explore?type=podfic' },
